...
const Toast = ({ type, message, onClose }) => {
    // Dynamic classes for icon background and text color
    const iconStyles = {
        success: {
    ...
    const { bgColor, textColor, icon } = iconStyles[type] || iconStyles.success; // Default to 'success'

    return (
        <div
            id="toast"
            className="fixed bottom-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 animate-fadeIn"
            role="alert"
        >
