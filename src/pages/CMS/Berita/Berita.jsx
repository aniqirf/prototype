...
import ListViewBerita from "./ListViewBerita";
import ListFormBerita from "./ListFormBerita";
...
const Berita = () => {
    ...
    const [data, setData] = React.useState([
        { id: 1, tajuk: "Berita Sabtu", kandungan:"lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", lampiran:"https://rtm-images.glueapi.io/960x0/news/BeritaWilayah.jpg", pautan:"https://kpkt.webflow.io/analytic", status: "Aktif" },        
        { id: 2, tajuk: "Berita Isnin", kandungan:"lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", lampiran:"https://rtm-images.glueapi.io/960x0/news/BeritaWilayah.jpg", pautan:"https://kpkt.webflow.io/analytic", status: "Aktif" },
        { id: 3, tajuk: "Berita Selesa", kandungan:"lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", lampiran:"https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80", pautan:"https://kpkt.webflow.io/analytic", status: "Aktif" },
        { id: 4, tajuk: "Berita Rabu", kandungan:"lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", lampiran:"https://rtm-images.glueapi.io/960x0/news/BeritaWilayah.jpg", pautan:"https://kpkt.webflow.io/analytic", status: "Aktif" },
        { id: 5, tajuk: "Berita Khamis", kandungan:"lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", lampiran:"https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80", pautan:"https://kpkt.webflow.io/analytic", status: "Aktif" }
    ]);
    ...
    return (
        <Layout title='Berita' subtitle='Memaparkan kesemua tetapan paparan berita di dalam system Kementerian Perumahan dan Kerajaan Tempatan' breadcrumb={breadcrumb}>
            <div className="flex">
            ...
            <ListFormBerita isOpen={open} toggleDrawer={toggleDrawer} addNewData={addNewData} updateData={updateData} selectedData={selectedData} setIsEdit={setIsEdit} isEdit={isEdit} />
            <ListViewBerita selectedData={selectedData} isOpen={openView} toggleDrawer={toggleDrawerView} />
        </Layout>
    )
}
