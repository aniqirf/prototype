...
const ListFormBerita = ({ isOpen, toggleDrawer, addNewData, updateData, selectedData, isEdit, setIsEdit }) => {
    ...
    return (
        <>
            <Drawer isOpen={isOpen} toggleDrawer={toggleDrawer} title={isEdit ? "Kemaskini Berita" : "Tambah Berita"} size="lg">
