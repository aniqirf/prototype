...
const ListViewBerita = ({ isOpen, toggleDrawer, selectedData }) => {
    ...
    return (
        <>
            <Drawer isOpen={isOpen} toggleDrawer={toggleDrawer} title="Maklumat Berita" size="lg">
