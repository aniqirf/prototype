...
import ListViewRole from "./ListViewRole";
import ListFormRole from "./ListFormRole";
...
const Role = () => {
    ...
    const [data, setData] = React.useState([
        ...
        {
            id: 2,
            role: "Pentadbir Modul",
            status: "Aktif",
            permissions: [1, 3]
        },
        {
            id: 3,
            role: "Penguna Berdaftar",
            status: "Aktif",
            permissions: [1]
        },
        {
        ...
        {
            id: 5,
            role: "Pentadbir Modul Pengurusan Data",
            status: "Tidak Aktif",
            permissions: [2, 4]
        }
    ...
    return (
        <Layout title='Tetapan Peranan' subtitle='Memaparkan kesemua tetapan peranan di dalam system TOK BALI SUPPLY BASE' breadcrumb={breadcrumb}>
            ...
            <ListFormRole isOpen={open} toggleDrawer={toggleDrawer} addNewData={addNewData} updateData={updateData} selectedData={selectedData} setIsEdit={setIsEdit} isEdit={isEdit} />
            <ListViewRole selectedData={selectedData} isOpen={openView} toggleDrawer={toggleDrawerView} />
        </Layout>
    )
}
