...
const PengesahanDataView = ({ isOpen, toggleDrawer, selectedData, updateData }) => {
    ...
    const handleSahkan = () => {
        if (!selectedData) {
            showToast("No data selected!", "error");
            return;
        }
        ...
        toggleDrawer();
        showToast("Data Berjaya Disahkan!");
    };
    ...
    const handleTolak = () => {
        ...
        updateData(updatedData);
        toggleDrawer();
        showToast("Data Berjaya Ditolak!");
    };
    ...
    return (
        <Drawer isOpen={isOpen} toggleDrawer={toggleDrawer} title="Pengesahan Data" size="lg">
            <div className="p-4 space-y-6">
                {/* Section: Data Title */}

                <div className="flex flex-row justify-between items-center gap-2">
                    <div className="flex flex-col gap-2">
                        <h2 className="text-2xl font-semibold">Pengesahan Data</h2>
                        <p className="text-sm text-gray-500">Sila semak dan sahkan maklumat data berikut.</p>
                    </div>
                    <div className="flex flex-row justify-between items-center gap-2">
                        <button
                            className="bg-green-500 hover:bg-green-700 text-white font-bold px-4 py-2 rounded-lg w-24"
                            onClick={handleSahkan}
                        >
                            Sahkan
                        </button>
                        <button
                            className="bg-red-500 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-lg w-24"
                            onClick={handleTolak}
                        >
                            Tolak
                        </button>
...
export default PengesahanDataView;
