...
function DataCollectionList() {
    ...
    const deleteData = (id) => {
        ...
        setData(updatedData);
        toast.success('Data Berjaya dipadam!', {
            position: "top-right",
            autoClose: 3000,
        });
    };
    ...
    const handleview = (id) => {
        ...
        setOpen1(true); // Ensure the drawer opens
    };
    ...
    return (
        <>
            <Layout title='Data Collection' subtitle='Senarai data collection daripada pengguna berdaftar' breadcrumb={breadcrumb}>
                <div className="flex">
                ...
                <DataCollectionView isOpen={open1} toggleDrawer={toggleDrawer1} selectedData={selectedData} />
                <ToastContainer />
            </Layout >
        </>
    )
